...
exports.config = {
  ...
  bower:                          # Configuration for bower module
    ...
    copy:                         # configuration for the copying of assets from bower temp
      ...
      mainOverrides: {"bootstrap":[{'dist/fonts':'fonts'}, {'dist/js/bootstrap.js':'bootstrap/bootstrap.js'}, {'dist/css/bootstrap.css':'bootstrap/bootstrap.css'}], 'socket.io-client':['dist/socket.io.js']}
